...
#ifndef CRAP_MATH_BASEMATH_H
#define CRAP_MATH_BASEMATH_H
...
//typedefs
typedef basemath<i32> basemathi;
typedef basemath<i64> basemathl;
typedef basemath<f32> basemathf;
typedef basemath<f64> basemathd;

}	// namespace crap


#endif // CRAP_MATH_BASEMATH_H
