========================================================================
    KONSOLENANWENDUNG: CRAPunittests-Projektübersicht
========================================================================

Diese CRAPunittests-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre CRAPunittests-Anwendung besteht.


CRAPunittests.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "CRAPunittests.pch und eine 
