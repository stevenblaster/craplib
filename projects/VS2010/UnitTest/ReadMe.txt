========================================================================
    STATISCHE BIBLIOTHEK: UnitTest-Projektübersicht
========================================================================

Dieses UnitTest-Bibliotheksprojekt wurde vom 
Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre UnitTest-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "UnitTest.pch und eine 
